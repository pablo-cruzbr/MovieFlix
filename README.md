...
* - **The Movie Database (TMDB)API v3 (playlistItems)**: rota GET para listar vídeos de uma playlist específica. <a href="[https://pablo-cruzbr.github.io/MovieFlix/](https://developer.themoviedb.org/docs/getting-started)" target="_blank">Clique aqui para ver a API</a>
